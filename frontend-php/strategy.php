...
<head>
  ...
  <title>SmarTest — Problema 1: Identificare Strategie</title>
  <link rel="stylesheet" href="css/style.css?v=8">
</head>
<body>
  <a href="index.php" class="back-home">⬅️ Înapoi la meniu</a>
  <div class="container">
    <h1>SmarTest — Problema 1: Identificare Strategie de Rezolvare</h1>
    ...
    <div id="solveSection">
        ...
        <div class="grid">
          <div>
            ...
            <select id="problemType">
              ...
              <option value="hanoi">Generalised Hanoi</option>
              <option value="graph_coloring">Graph Coloring</option>
              <option value="knight_tour">Knight's Tour</option>
            </select>
          </div>
          <div>
      ...
      <div class="card">
        ...
        <div class="row">
          <input id="answer" placeholder="ex: Backtracking sau 1 (numărul opțiunii)">
    ...
    <div id="customSection" style="display:none;">
      <div class="card">
        ...
        <p>
          Poți introduce propria problemă: alege tipul de problemă și descrie instanța.
        </p>
        ...
        <div class="grid">
          ...
          <div style="grid-column: 1 / -1;">
            ...
            <textarea id="customInstance" rows="4" placeholder="Descrie instanța problemei..."></textarea>
          </div>
        </div>

        <button id="solveCustomBtn">Calculează strategia</button>
