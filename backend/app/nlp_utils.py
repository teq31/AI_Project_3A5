...
def extract_key_concepts(text: str, keywords: List[str]) -> Dict[str, Any]:
    ...
    for keyword in keywords:
        ...
        # Verificare similaritate semantică
        similarity = semantic_similarity(text, keyword)
        if similarity >= 0.6:  # Prag pentru considerare "găsit"
            found_keywords.append(keyword)
...
def compare_answers_natural(user_answer: str, correct_answer: str, 
    ...
    Args:
        ...
        threshold: Prag minim pentru considerare "corect" (0-1)
    ...
    elif similarity >= threshold * 0.7:  # 70% din prag
